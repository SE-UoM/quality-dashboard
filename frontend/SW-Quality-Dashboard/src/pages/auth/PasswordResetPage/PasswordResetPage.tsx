...
function PasswordResetPage() {
    ...
    // If the url has no query parameters, redirect to the home page
    useEffect(() => {
        let noParams = location.search === ""
        let noID = !location.search.includes("uid")
        let noToken = !location.search.includes("token")

        if (noParams || noID || noToken) {
                    ...
                    <div className="card w-96 bg-base-300 text-primary-content shrink-0 max-w-sm">
                        ...
                        <form className="card-body w-100 p-0">
                            ...
                            <div className="form-control">
                                <div className="flex justify-content-evenly text-neutral-content">
                                    ...
                                    >
                                        ...
                                        >
                                            {showRepeatPassword ? <i className="bi bi-eye-slash-fill"> </i> :
                                                <i className="bi bi-eye-fill"> </i>}
                                        </div>
                                    </label>
                                </div>
                            ...
                            <span style={{color: "#949ba8"}} className="label-text">
                                I am not a <i style={{fontSize: "1em", color: "#949ba8"}}
                                              className={"bi bi-robot"}> </i> (robot).
                            </span>
                                    <input
                                        type="checkbox"
                                        className="checkbox "
                            ...
                            <button className="btn btn-accent w-full" onClick={handlePasswordReset}>
                                {!loading &&
                                    <i style={{fontSize: "1em"}} className="bi bi-arrow-right-circle-fill"> </i>}
                    ...
                    <dialog id="pass_reset_modal" className="modal modal-bottom sm:modal-middle">
                        <div className="modal-box">
                            ...
                            <p className="py-4">
                                ...
                                You password has been reset successfully. You can now login with your new
                                password. <br/><br/>
