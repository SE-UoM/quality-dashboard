...
function AuthPage({isAuth}) {
    ...
    // If the url is /auth/login then show the login form
    // If the url is /auth/register then show the register form
    useEffect(() => {
        ...
        <div className="login-page">
            {!isAuth &&
                <>
                    ...
                    <div className="auth-page-content w-100">
                        <div className="theme-toggle m-4"
                        ...
                        {
                            formType !== 'none' && formType === 'login' &&
                            <LoginForm />
                        }
                        {
                            formType !== 'none' && formType === 'register' &&
                            <SignUpForm />
                        }
                    </div>
                </>
