...
* The original package name 'uom.qualitydashboard.user-verification-service' is invalid and this project uses 'uom.qualitydashboard.userverificationservice' instead.
